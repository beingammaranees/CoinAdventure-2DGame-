    ...
    public partial class Form1 : Form
    {
        ...
        private void MainGameTimerEvent(object sender, EventArgs e)
        {
                ...
                if (x is PictureBox)
                {
                    ...
                    if ((string)x.Tag == "enemy")
                    {
                        if (player.Bounds.IntersectsWith(x.Bounds))
                        {
                            ...
                            isGameOver = true;
                            txtScore.Text = "Score: " + score;
                            MessageBox.Show("Such a Noob!!","HAHA",MessageBoxButtons.OK,MessageBoxIcon.Exclamation);
                        }
                    }
            ...
            if (player.Top + player.Height > this.ClientSize.Height + 50)
            {
                ...
                isGameOver = true;
                txtScore.Text = "Score: " + score ;
                MessageBox.Show("You Comitted Suicide!!", "LOL", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            ...
            if (player.Bounds.IntersectsWith(door.Bounds) && score == 26)
            {
                ...
                isGameOver = true;
                txtScore.Text = "Score: " + score;
                MessageBox.Show("You Won, Now leave and never comeback!!", "BRO", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            else
            {
